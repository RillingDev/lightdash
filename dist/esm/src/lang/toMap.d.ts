 ...
 */
declare const toMap: <TValue, UKey, VInitialValue>(object: Dictionary<VInitialValue> | NumericDictionary<VInitialValue>, keyMapper?: (key: PropertyKey) => UKey, valueMapper?: (value: VInitialValue) => TValue) => Map<UKey, TValue>;
export { toMap };
